...
const serviciosData = [
  {
    ...
    description:
      "Técnicas especializadas para definir, dar forma y realzar tus uñas, creando el marco perfecto para tu manicura.",
    items: [
      {
        name: "Uñas semipermanentes",
        price: "10€",
        details: "Técnica para dejar tus uñas impecables.",
      },
      {
        name: "Uñas semipermanentes con refuerzo con 2 decoraciones",
        price: "12€",
        details:
          "Técnica para dejar tus uñas impecables y duraderas con 2 decoraciones.",
      },
      {
        name: "Técnica gel Express",
        price: "15€",
        details:
          "Técnica rápida para uñas de gel que proporciona un acabado perfecto en poco tiempo.",
      },
      {
        name: "Pedicura",
        price: "10€",
        details: "Cuidado y embellecimiento de tus pies.",
      },
      {
        name: "Pedicura con esmaltado",
        price: "12€",
        details: "Cuidado y embellecimiento de tus pies con esmaltado.",
      },
    ],
  },
  {
    ...
    description:
      "Soluciones para conseguir unas pestañas más largas, curvadas y con volumen, para una mirada abierta e impactante.",
    items: [
      {
        name: "Extensiones de Pestañas",
        price: "15€",
        details: "Técnica para alargar y dar volumen a tus pestañas.",
      },
      {
        name: "Lifting de Pestañas",
        price: "12€",
        details: "Eleva y curva tus pestañas naturales desde la raíz.",
      },
      {
        name: "Lifting de Pestañas + Tinte",
        price: "15€",
        details:
          "Eleva y curva tus pestañas naturales desde la raíz. Incluye tinte.",
      },
    ],
  },
];
    ...
    <div className="space-y-12 py-4">
      ...
      <header className="text-center px-4">
        ...
        <p className="mt-4 max-w-2xl mx-auto text-black">
          Descubre todos nuestros tratamientos diseñados para realzar tu belleza
          natural. Nos dedicamos a ofrecer resultados impecables con una
          ...
          >
            <div className="text-center mb-8">
              ...
              <h2
                ...
                className="text-3xl font-serif text-black relative inline-block pb-2 after:block after:absolute after:bottom-0 after:left-1/4 after:w-1/2 after:h-1 after:bg-brand-accent after:rounded-full"
              >
                {category.category}
              </h2>
            ...
            <div className="space-y-6">
              {category.items.map((service) => (
                <div
                  key={service.name}
                  className="relative bg-white p-6 rounded-2xl shadow-lg border border-brand-secondary/50 transform transition-transform hover:scale-[1.02] duration-300 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4"
                >
                  <div className="pr-4">
      ...
      <section className="text-center py-10 bg-brand-secondary/50 rounded-3xl mx-3 sm:mx-0 px-2">
        ...
        <p className="mt-4 text-black max-w-xl mx-auto">
          Tu momento de relax y belleza te está esperando. Reserva tu cita y
          déjate cuidar.
        </p>
        <button
